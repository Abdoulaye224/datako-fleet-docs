...
export const ONBOARDING_PARCOURS: OnboardingParcours[] = [
  {
    ...
    steps: [
      ...
      { titre: 'Ajouter votre premier camion', description: 'Enregistrez un véhicule dans la flotte avec ses informations et son type (propre ou géré).', href: '/transport/guides/ajouter-camion' },
      { titre: 'Ajouter un client', description: 'Créez le profil d\'un client pour pouvoir lui attribuer des rotations.', href: '/transport/guides/ajouter-client' },
      { titre: 'Créer une rotation', description: 'Enregistrez votre première livraison : camion, client, destination, volume.', href: '/transport/guides/creer-rotation' },
      { titre: 'Valider la livraison', description: 'Saisissez le volume livré réel et marquez la livraison comme effectuée.', href: '/transport/guides/valider-livraison' },
  ...
  },
  {
    ...
    duree: '10 min',
    steps: [
      { titre: 'Comprendre votre rôle', description: 'Découvrez ce que vous pouvez et ne pouvez pas faire en tant qu\'Opérateur.', href: '/roles/operator' },
  ...
  },
  {
    ...
    steps: [
      ...
      { titre: 'Générer un relevé client PDF', description: 'Créer et télécharger un relevé pour un client sur une période.', href: '/transport/guides/releve-client-pdf' },
  ...
  },
  {
    ...
    duree: '5 min',
    steps: [
      { titre: 'Comprendre votre rôle Propriétaire', description: 'Ce que vous pouvez voir et les limites de votre accès.', href: '/roles/owner' },
      ...
      { titre: 'Télécharger votre bilan PDF', description: 'Générer votre bilan mensuel pour archivage ou validation.', href: '/transport/guides/bilan-proprietaire-pdf' },
    ],
  },
]
