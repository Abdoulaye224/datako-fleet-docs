...
export const guides: Guide[] = [
  ...
  },
  {
    ...
    etapes: [
      ...
      'Consultez le tableau de bord des niveaux : chaque produit affiche le stock actuel, le seuil d\'alerte et le statut (OK / Alerte / Rupture).',
      'Pour enregistrer un approvisionnement, cliquez sur "+ Entrée stock" sur la ligne du produit concerné.',
      'Saisissez la quantité reçue, la date de réception et optionnellement le fournisseur ou le numéro de bon de livraison.',
      'Validez : le stock disponible est immédiatement mis à jour.',
      'Pour visualiser les mouvements d\'un produit (entrées, sorties par livraison, ajustements), cliquez sur son nom puis ouvrez l\'onglet "Mouvements".',
      'Pour corriger un écart (stock physique ≠ stock logiciel), cliquez sur "Ajustement" et saisissez le stock réel avec un motif (inventaire, casse, erreur de saisie).',
    ],
    resultat: 'Le stock est à jour et reflète la réalité terrain. Les livraisons validées débitent automatiquement le stock. Les alertes de niveau bas sont visibles sur le tableau de bord Vente.',
    erreurs: [
      'Si le stock d\'un produit descend sous le seuil sans alerte, vérifiez que le seuil d\'alerte est bien configuré dans la fiche produit.',
      'Un approvisionnement saisi sur la mauvaise date peut fausser l\'historique des mouvements — vérifiez la date avant de valider.',
      'Les ajustements de stock sont tracés avec l\'utilisateur et l\'horodatage. Ils sont visibles par l\'Administrateur dans le journal des mouvements.',
      'Une commande client ne peut pas être confirmée si le stock disponible est insuffisant. Approvisionner avant de planifier la tournée.',
    ],
