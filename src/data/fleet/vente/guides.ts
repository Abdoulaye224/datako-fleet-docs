...
export const guides: Guide[] = [
  ...
  },
  {
    ...
    suivant: { href: '/vente/guides/gerer-stock', titre: 'Gérer mon stock' },
    articlesConnexes: [
  ...
  },
  {
    ...
    objectif: 'Suivre les niveaux de stock en temps réel, enregistrer un approvisionnement et visualiser les mouvements pour éviter les ruptures.',
    prerequis: [
      'Avoir le rôle Administrateur ou Chef d\'exploitation',
      'Les produits distribués doivent être configurés dans le référentiel Vente',
    ],
    etapes: [
      'Allez dans Vente > Stocks.',
      'Consultez le tableau de bord : chaque sommier (cuve ou compartiment) affiche le volume actuel en litres. Une icône rouge pulsante indique un niveau critique.',
      'Pour enregistrer un approvisionnement, cliquez sur "+ Entrée stock" sur le sommier concerné.',
      'Saisissez le volume en litres reçu et la date de l\'entrée, puis validez. Le stock du sommier est immédiatement mis à jour.',
      'Pour visualiser tous les mouvements d\'un sommier (entrées, sorties par vente, ajustements), cliquez sur son nom puis ouvrez l\'onglet "Mouvements".',
      'Pour corriger un écart entre stock physique et stock logiciel, cliquez sur "Ajustement". Choisissez le type (perte, correction, fuite, etc.), sélectionnez le sommier, entrez le volume à retirer et rédigez un motif obligatoire (ex : "Fuite détectée sur cuve n°2").',
      'Validez l\'ajustement. Il est immédiatement tracé avec votre nom et l\'horodatage, et visible dans le journal des mouvements.',
    ],
    resultat: 'Le stock de chaque sommier est à jour et reflète la réalité terrain. Les ventes validées débitent automatiquement le sommier concerné. Les niveaux critiques sont signalés visuellement en temps réel.',
    erreurs: [
      'Les alertes visuelles (icône rouge) sont calculées automatiquement — il n\'y a pas de seuil paramétrable par produit. Si aucune alerte ne s\'affiche malgré un niveau bas, vérifiez que le bon sommier est sélectionné.',
      'Un approvisionnement saisi sur la mauvaise date fausse l\'historique des mouvements. Vérifiez la date avant de valider.',
      'Les ajustements d\'écart ne concernent que les sorties non-commerciales (perte, fuite, correction). Les ventes clients passent exclusivement par "Nouvelle Vente" et non par un ajustement.',
      'Une commande client ne peut pas être confirmée si le volume disponible dans le sommier est insuffisant. Approvisionnez avant de planifier la tournée.',
    ],
    href: '/vente/guides/gerer-stock',
    precedent: { href: '/vente/guides/exporter-rapport-vente', titre: 'Exporter le rapport de vente' },
    articlesConnexes: [
      { href: '/vente/pages/stocks', titre: 'Page Stocks', section: 'Pages Vente' },
