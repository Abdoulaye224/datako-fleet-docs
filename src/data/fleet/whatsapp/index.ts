...
export const WHATSAPP_FLUX: WhatsAppFlux[] = [
  ...
  },
  {
    ...
    profil: 'conducteur',
    description: 'Le conducteur confirme son départ en répondant directement par texte libre dans la conversation WhatsApp du bot. Le bot traite la réponse et met à jour le statut conducteur dans Fleet Manager.',
    quand: 'Quand le conducteur répond au message d\'affectation reçu sur WhatsApp en confirmant son départ.',
    messageType: 'validation',
    exempleMessage: 'Départ confirmé à 07:42. Chargement complet, tournée #TV-0629-04. Bonne route.',
    activation: 'Dans Paramètres > WhatsApp > Flux terrain, activez la confirmation de départ. Le statut "confirme_chauffeur" (✅) apparaît alors dans la page Livraisons à côté du nom du conducteur. Disponible selon abonnement.',
  ...
  },
  {
    ...
    profil: 'conducteur',
    description: 'Le conducteur valide la remise au client en répondant par texte libre dans WhatsApp. Deux statuts sont possibles : "confirme_chauffeur" (✅) si tout s\'est bien passé, ou "probleme_signale" (⚠️) en cas d\'incident. Ces badges sont visibles dans la page Livraisons.',
    quand: 'Quand le conducteur confirme ou signale un problème après la remise au client, en répondant dans la conversation WhatsApp du bot.',
    messageType: 'validation',
    exempleMessage: 'Livraison confirmée à 11:18 chez Pharmacie Lambandji. Quantité livrée : 120 cartons.',
    activation: 'Dans Paramètres > Notifications > WhatsApp, activez "Confirmation de livraison". Le bot met à jour le driver_status dans Fleet Manager à réception de la réponse. Disponible selon abonnement.',
